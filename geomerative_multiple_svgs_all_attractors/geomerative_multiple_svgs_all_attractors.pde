...
void keyPressed() {
   ...
   if(key == '1'){
       foundTarget = true;
       ps.setTarget(starTargets);
   }
   
   if(key == '2'){
       foundTarget = true;
       ps.setTarget(rectTargets);
   }
   
   if(key == '3'){
      foundTarget = true;
      ps.setTarget(circleTargets);
   }
   
   if(key == '4'){
      foundTarget = true;
      ps.setTarget(cluster.particles);
   }
